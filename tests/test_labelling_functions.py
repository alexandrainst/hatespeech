...
@pytest.mark.parametrize(
    ...
    argvalues=[
        ...
        (lfs.use_danlp_model, offensive_record1, lfs.OFFENSIVE),
        (lfs.use_danlp_model, offensive_record2, lfs.OFFENSIVE),
        (lfs.use_danlp_model, offensive_record3, lfs.OFFENSIVE),
        (lfs.use_danlp_model, positive_record, lfs.NOT_OFFENSIVE),
        (lfs.use_danlp_model, mention_record, lfs.NOT_OFFENSIVE),
        (lfs.use_danlp_model, dr_answer_record, lfs.NOT_OFFENSIVE),
        (lfs.use_danlp_model, all_caps_record, lfs.ABSTAIN),
        (lfs.use_danlp_model, positive_swear_word_record, lfs.ABSTAIN),
        (lfs.use_attack_model, offensive_record1, lfs.OFFENSIVE),
        (lfs.use_attack_model, offensive_record2, lfs.OFFENSIVE),
        (lfs.use_attack_model, offensive_record3, lfs.OFFENSIVE),
    ...
    ids=[
        ...
        "use_danlp_model_offensive_record1",
        "use_danlp_model_offensive_record2",
        "use_danlp_model_offensive_record3",
        "use_danlp_model_positive_record",
        "use_danlp_model_mention",
        "use_danlp_model_dr_answer",
        "use_danlp_model_all_caps",
        "use_danlp_model_positive_swear_word",
        "use_attack_model_offensive_record1",
        "use_attack_model_offensive_record2",
        "use_attack_model_offensive_record3",
        "use_attack_model_positive_record",
        "use_attack_model_mention",
        "use_attack_model_dr_answer",
        "use_attack_model_all_caps",
        "use_attack_model_positive_swear_word",
